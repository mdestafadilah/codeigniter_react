...
class Twig {
    ...
    public function __construct($twig_version)
    {
        if (!DEFINED("EXT")) define("EXT", ".php");
        ini_set('include_path', ini_get('include_path') . PATH_SEPARATOR . APPPATH . 'third_party/'.$twig_version.'/lib/Twig');
    ...
    public function twig_loader($template=null,$twig_string=null,$data=array(),$return=FALSE)
    {
        ...
        return ($return === TRUE)?$twig->render($template, $data):$twig->display($template, $data);
    }
